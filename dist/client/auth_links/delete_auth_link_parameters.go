...
// WithDefaults hydrates default values in the delete auth link params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteAuthLinkParams) WithDefaults() *DeleteAuthLinkParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete auth link params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteAuthLinkParams) SetDefaults() {
