...
// SetConnectionID adds the connectionId to the get connection params
func (o *GetConnectionParams) SetConnectionID(connectionID string) {
	o.ConnectionID = connectionID
}

// WithUserID adds the userID to the get connection params
func (o *GetConnectionParams) WithUserID(userID string) *GetConnectionParams {
	o.SetUserID(userID)
	return o
}

// SetUserID adds the userId to the get connection params
func (o *GetConnectionParams) SetUserID(userID string) {
	o.UserID = userID
}
