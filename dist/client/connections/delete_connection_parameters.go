...
// SetConnectionID adds the connectionId to the delete connection params
func (o *DeleteConnectionParams) SetConnectionID(connectionID string) {
	o.ConnectionID = connectionID
}

// WithUserID adds the userID to the delete connection params
func (o *DeleteConnectionParams) WithUserID(userID string) *DeleteConnectionParams {
	o.SetUserID(userID)
	return o
}

// SetUserID adds the userId to the delete connection params
func (o *DeleteConnectionParams) SetUserID(userID string) {
	o.UserID = userID
}
