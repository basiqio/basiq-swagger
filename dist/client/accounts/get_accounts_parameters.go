...
// WithUserID adds the userID to the get accounts params
func (o *GetAccountsParams) WithUserID(userID string) *GetAccountsParams {
	o.SetUserID(userID)
	return o
}

// SetUserID adds the userId to the get accounts params
func (o *GetAccountsParams) SetUserID(userID string) {
	o.UserID = userID
}
