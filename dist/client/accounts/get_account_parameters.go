...
// WithUserID adds the userID to the get account params
func (o *GetAccountParams) WithUserID(userID string) *GetAccountParams {
	o.SetUserID(userID)
	return o
}

// SetUserID adds the userId to the get account params
func (o *GetAccountParams) SetUserID(userID string) {
	o.UserID = userID
}
