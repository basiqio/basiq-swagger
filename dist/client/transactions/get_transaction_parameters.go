...
// WithUserID adds the userID to the get transaction params
func (o *GetTransactionParams) WithUserID(userID string) *GetTransactionParams {
	o.SetUserID(userID)
	return o
}

// SetUserID adds the userId to the get transaction params
func (o *GetTransactionParams) SetUserID(userID string) {
	o.UserID = userID
}
