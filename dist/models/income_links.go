...
// ContextValidate validates this income links based on context it is used
func (m *IncomeLinks) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
