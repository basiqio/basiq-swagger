...
// ContextValidate validates this transactions get links based on context it is used
func (m *TransactionsGetLinks) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
