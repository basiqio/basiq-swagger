...
// ContextValidate validates this group details based on context it is used
func (m *GroupDetails) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
