...
// ContextValidate validates this transaction links based on context it is used
func (m *TransactionLinks) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
